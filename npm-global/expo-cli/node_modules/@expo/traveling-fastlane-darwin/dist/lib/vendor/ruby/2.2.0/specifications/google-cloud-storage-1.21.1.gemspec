...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<google-api-client>, ["~> 0.26"])
      s.add_runtime_dependency(%q<googleauth>, ["< 0.10.0", ">= 0.6.2"])
      s.add_runtime_dependency(%q<digest-crc>, ["~> 0.4"])
      s.add_runtime_dependency(%q<addressable>, ["~> 2.5"])
      s.add_runtime_dependency(%q<mini_mime>, ["~> 1.0"])
      ...
      s.add_dependency(%q<google-api-client>, ["~> 0.26"])
      s.add_dependency(%q<googleauth>, ["< 0.10.0", ">= 0.6.2"])
      s.add_dependency(%q<digest-crc>, ["~> 0.4"])
      s.add_dependency(%q<addressable>, ["~> 2.5"])
      s.add_dependency(%q<mini_mime>, ["~> 1.0"])
