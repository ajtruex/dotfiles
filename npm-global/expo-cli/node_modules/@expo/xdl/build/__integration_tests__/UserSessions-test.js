...
describe.skip('User Sessions', () => {
  ...
  it('should login successfully, and persist a session token upon login', async () => {
    ...
    await UserManager.loginAsync('user-pass', {
      ...
      password: userForTestPassword // testSession: true,
    ...
    const auth = await _UserSettings().default.getAsync('auth', null);
    expect(auth === null || auth === void 0 ? void 0 : auth.sessionSecret).not.toBe(undefined);
  });
  it('should remove a session token upon logout', async () => {
    ...
    const auth = await _UserSettings().default.getAsync('auth', null);
    expect(auth === null || auth === void 0 ? void 0 : auth.sessionSecret).toBe(undefined);
  });
