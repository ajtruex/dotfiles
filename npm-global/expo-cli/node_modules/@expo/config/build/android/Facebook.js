...
async function setFacebookConfig(config, manifestDocument) {
    ...
    if (appId) {
        ...
        mainApplication = Manifest_1.removeMetaDataItemFromMainApplication(mainApplication, 'com.facebook.sdk.ApplicationId');
    }
    if (displayName) {
        mainApplication = Manifest_1.addMetaDataItemToMainApplication(mainApplication, 'com.facebook.sdk.ApplicationName', displayName);
    }
    else {
        mainApplication = Manifest_1.removeMetaDataItemFromMainApplication(mainApplication, 'com.facebook.sdk.ApplicationName');
    }
    if (autoInitEnabled !== null) {
        ...
        mainApplication = Manifest_1.removeMetaDataItemFromMainApplication(mainApplication, 'com.facebook.sdk.AutoInitEnabled');
    }
    if (autoLogAppEvents !== null) {
        ...
        mainApplication = Manifest_1.removeMetaDataItemFromMainApplication(mainApplication, 'com.facebook.sdk.AutoLogAppEventsEnabled');
    }
    if (advertiserIdCollection !== null) {
        ...
        mainApplication = Manifest_1.removeMetaDataItemFromMainApplication(mainApplication, 'com.facebook.sdk.AdvertiserIDCollectionEnabled');
    }
