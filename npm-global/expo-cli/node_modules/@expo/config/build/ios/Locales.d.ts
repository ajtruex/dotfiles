...
export declare function getLocales(config: ExpoConfig): Record<string, string | LocaleJson> | null;
export declare function setLocalesAsync(config: ExpoConfig, { projectRoot, project }: {
    projectRoot: string;
