...
function getAppLookupParams(experienceName, bundleIdentifier) {
  ...
  (0, _invariant().default)(matchedExperienceName && matchedExperienceName.length >= 3, 'invalid experience name');
  return {
...
class IosApi {
  ...
  async createDistCert(accountName, credentials) {
    ...
    (0, _invariant().default)(id && distCert, 'distribution certificate does not exists');
    (0, _invariant().default)(distCert.type === 'dist-cert', 'wrong type of user credential');
    return distCert;
  }
  ...
  async updateDistCert(id, accountName, credentials) {
    ...
    (0, _invariant().default)(distCert, 'distribution certificate does not exists');
    (0, _invariant().default)(distCert.type === 'dist-cert', 'wrong type of user credential');
    return distCert;
  }
  ...
  async createPushKey(accountName, credentials) {
    ...
    (0, _invariant().default)(id && pushKey, 'push key does not exists');
    (0, _invariant().default)(pushKey.type === 'push-key', 'wrong type of user credentials');
    return pushKey;
  }
