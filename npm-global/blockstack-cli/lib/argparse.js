...
exports.DEFAULT_CONFIG_REGTEST_PATH = '~/.blockstack-cli-regtest.conf';
exports.DEFAULT_CONFIG_TESTNET_PATH = '~/.blockstack-cli-testnet.conf';
            ...
            items: [
                {
                    ...
                    type: 'string',
                    realtype: 'blockstack_id',
                    pattern: exports.SUBDOMAIN_PATTERN
                },
                {
                    name: 'owner_key',
                    type: 'string',
...
;
function getCLIOpts(argv, opts = 'deitUxC:F:B:P:D:G:N:H:T:I:m:M:X:u:p:') {
    const optsTable = {};
    const remainingArgv = [];
