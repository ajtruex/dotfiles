...
import { BurnchainRewardListResponse, BurnchainRewardsTotal } from '../models';
 ...
 *
 */
export declare class BurnchainApi extends runtime.BaseAPI implements BurnchainApiInterface {
    /**
     * Get a list of recent burnchain (e.g. Bitcoin) reward recipients with the associated amounts and block info
     * Get recent burnchain reward recipients
     */
