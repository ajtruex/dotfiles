(function (global, factory) {
  ...
  function getAddressHashMode(btcAddress) {
    if (btcAddress.startsWith('bc1') || btcAddress.startsWith('tb1')) {
      var _address$fromBech = bitcoinjsLib.address.fromBech32(btcAddress),
          data = _address$fromBech.data;

      if (data.length === 32) {
        return transactions.AddressHashMode.SerializeP2WSH;
      } else {
        return transactions.AddressHashMode.SerializeP2WPKH;
      }
    } else {
  ...
  function decodeBtcAddress(btcAddress) {
    ...
    if (btcAddress.startsWith('bc1') || btcAddress.startsWith('tb1')) {
      var _address$fromBech2 = bitcoinjsLib.address.fromBech32(btcAddress),
      ...
      var _address$fromBase58Ch2 = bitcoinjsLib.address.fromBase58Check(btcAddress),
  ...
  var StackingClient = /*#__PURE__*/function () {
            ...
            switch (_context7.prev = _context7.next) {
              ...
              case 3:
                ...
                return _context7.abrupt("return", Promise.all([poxInfoPromise, targetBlockTimePromise, coreInfoPromise]).then(function (_ref2) {
                  ...
                  var cycleDuration = poxInfo.reward_cycle_length * targetBlockTime;
            ...
            switch (_context10.prev = _context10.next) {
              case 0:
                ...
                return _context10.abrupt("return", Promise.all([balancePromise, poxInfoPromise]).then(function (_ref4) {
                  ...
                  var hashModeBuffer = transactions.bufferCV(new BN__default['default'](hashMode, 10).toBuffer());
                  ...
                  var _poxInfo$contract_id$ = poxInfo.contract_id.split('.'),
                      contractAddress = _poxInfo$contract_id$[0],
                      contractName = _poxInfo$contract_id$[1];
    ...
    _proto.stack = /*#__PURE__*/function () {
      var _stack = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee11(_ref5) {
        var amountMicroStx, poxAddress, cycles, privateKey, burnBlockHeight, poxInfo, contract, txOptions, tx, res;
          ...
          while (1) {
            switch (_context11.prev = _context11.next) {
              ...
              case 8:
                tx = _context11.sent;
                _context11.next = 11;
                return transactions.broadcastTransaction(tx, txOptions.network);
    ...
    _proto.getStackOptions = function getStackOptions(_ref6) {
      var amountMicroStx = _ref6.amountMicroStx,
          poxAddress = _ref6.poxAddress,
          cycles = _ref6.cycles,
          contract = _ref6.contract,
          burnBlockHeight = _ref6.burnBlockHeight;
      ...
      var _contract$split = contract.split('.'),
          contractAddress = _contract$split[0],
          contractName = _contract$split[1];
    ...
    _proto.getStatus = /*#__PURE__*/function () {
      var _getStatus = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee12() {
        var _yield$this$getPoxInf, contractAddress, contractName, account, functionName;
        ...
        return runtime_1.wrap(function _callee12$(_context12) {
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 2:
                _yield$this$getPoxInf = _context12.sent.contract_id.split('.');
                contractAddress = _yield$this$getPoxInf[0];
                contractName = _yield$this$getPoxInf[1];
                _context12.next = 7;
              ...
              case 7:
                ...
                return _context12.abrupt("return", transactions.callReadOnlyFunction({
                  contractAddress: contractAddress,
                  contractName: contractName,
                  ...
                  if (responseCV.type === transactions.ClarityType.OptionalSome) {
                    var someCV = responseCV;
                    var _tupleCV = someCV.value;
    ...
    _proto.modifyLockTxFee = function modifyLockTxFee(_ref7) {
      var tx = _ref7.tx,
          amountMicroStx = _ref7.amountMicroStx;
      var fee = tx.auth.getFee();
      tx.payload.functionArgs[0] = transactions.uintCV(new BN__default['default'](amountMicroStx.toString(10), 10).sub(fee).toBuffer());
      return tx;
    };
