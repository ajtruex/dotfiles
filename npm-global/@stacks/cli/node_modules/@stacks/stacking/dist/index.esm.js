...
import { bufferCV, tupleCV, uintCV, callReadOnlyFunction, ClarityType, cvToString, broadcastTransaction, makeContractCall, standardPrincipalCV } from '@stacks/transactions';
...
var StackingClient = /*#__PURE__*/function () {
          ...
          switch (_context10.prev = _context10.next) {
            case 0:
              ...
              return _context10.abrupt("return", Promise.all([balancePromise, poxInfoPromise]).then(function (_ref4) {
                ...
                var hashModeBuffer = bufferCV(new BN(hashMode, 10).toBuffer());
        ...
        while (1) {
          switch (_context12.prev = _context12.next) {
            ...
            case 7:
              ...
              return _context12.abrupt("return", callReadOnlyFunction({
                contractAddress: contractAddress,
                contractName: contractName,
  ...
  _proto.modifyLockTxFee = function modifyLockTxFee(_ref7) {
    ...
    tx.payload.functionArgs[0] = uintCV(new BN(amountMicroStx.toString(10), 10).sub(fee).toBuffer());
    return tx;
  };
