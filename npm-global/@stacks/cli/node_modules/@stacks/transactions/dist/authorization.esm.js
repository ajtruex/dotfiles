...
import { serializePublicKey, deserializePublicKey, createStacksPublicKey, isCompressed, signWithKey, getPublicKey, publicKeyFromSignature } from './keys.esm.js';
...
function nextSignature(curSigHash, authType, fee, nonce, privateKey) {
  ...
  var publicKeyEncoding = isCompressed(publicKey) ? PubKeyEncoding.Compressed : PubKeyEncoding.Uncompressed;
...
function nextVerification(initialSigHash, authType, fee, nonce, pubKeyEncoding, signature) {
  ...
  var nextSigHash = makeSigHashPostSign(sigHashPreSign, PubKeyEncoding.Compressed, signature);
  return {
    pubKey: publicKey,
    nextSigHash: nextSigHash
  };
