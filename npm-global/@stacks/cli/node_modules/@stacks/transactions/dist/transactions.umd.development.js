(function (global, factory) {
  ...
  function publicKeyFromSignature(message, messageSignature) {
  ...
  function signWithKey(privateKey, input) {
    ...
    var recoverableSignature = createMessageSignature(recoverableSignatureString);
  ...
  function nextSignature(curSigHash, authType, fee, nonce, privateKey) {
    ...
    var publicKeyEncoding = isCompressed(publicKey) ? exports.PubKeyEncoding.Compressed : exports.PubKeyEncoding.Uncompressed;
    var nextSigHash = makeSigHashPostSign(sigHashPreSign, publicKeyEncoding, signature);
    return {
      nextSig: signature,
  ...
  function nextVerification(initialSigHash, authType, fee, nonce, pubKeyEncoding, signature) {
    ...
    var publicKey = createStacksPublicKey(publicKeyFromSignature(sigHashPreSign, signature));
    var nextSigHash = makeSigHashPostSign(sigHashPreSign, exports.PubKeyEncoding.Compressed, signature);
    return {
      pubKey: publicKey,
      nextSigHash: nextSigHash
    };
  ...
  function broadcastTransaction(_x5, _x6) {
    return _broadcastTransaction.apply(this, arguments);
  }

  function _broadcastTransaction() {
    _broadcastTransaction = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee3(transaction, network) {
      var rawTx, url;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              ...
              return _context3.abrupt("return", broadcastRawTransaction(rawTx, url));
  ...
  function broadcastRawTransaction(_x7, _x8) {
    return _broadcastRawTransaction.apply(this, arguments);
  }

  function _broadcastRawTransaction() {
    _broadcastRawTransaction = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee4(rawTx, url) {
      var requestHeaders, options, response, text;
      ...
      }, _callee4, null, [[6, 12], [18, 22]]);
    }));
    return _broadcastRawTransaction.apply(this, arguments);
  }

  function getAbi(_x9, _x10, _x11) {
  ...
  function makeUnsignedSTXTokenTransfer(_x12) {
  ...
  function makeSTXTokenTransfer(_x13) {
  ...
  function estimateContractDeploy(_x14, _x15) {
  ...
  function makeContractDeploy(_x16) {
  ...
  function estimateContractFunctionCall(_x17, _x18) {
  ...
  function makeUnsignedContractCall(_x19) {
  ...
  function makeContractCall(_x20) {
  ...
  function callReadOnlyFunction(_x21) {
  ...
  function sponsorTransaction(_x22) {
      ...
      return runtime_1.wrap(function _callee14$(_context14) {
        while (1) {
          switch (_context14.prev = _context14.next) {
            ...
            case 21:
              throw new Error("Spnsored transactions not supported for transaction type " + exports.PayloadType[options.transaction.payload.payloadType]);
