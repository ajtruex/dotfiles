...
export declare function getAvatarUrl(profile: any): null;
export declare function getVerifiedAccounts(profile: any, verifications?: any[]): any[] | null;
export declare function getOrganizations(profile: any): any;
export declare function getConnections(profile: any): any;
export declare function getAddress(profile: any): string | null;
export declare function getBirthDate(profile: any): string | null;
