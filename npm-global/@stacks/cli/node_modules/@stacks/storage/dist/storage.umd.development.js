(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('bitcoinjs-lib'), require('jsontokens'), require('@stacks/encryption'), require('@stacks/common'), require('@stacks/auth')) :
  typeof define === 'function' && define.amd ? define(['exports', 'bitcoinjs-lib', 'jsontokens', '@stacks/encryption', '@stacks/common', '@stacks/auth'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['@stacks/storage'] = {}, global.bitcoinjsLib, global.jsontokens, global.encryption, global.common, global.auth));
}(this, (function (exports, bitcoinjsLib, jsontokens, encryption, common, auth) { 'use strict';
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              common.Logger.debug("uploadToGaiaHub: uploading " + filename + " to " + hubConfig.server);
              headers = {
              ...
              _context.next = 7;
              return common.fetchPrivate(hubConfig.server + "/store/" + hubConfig.address + "/" + filename, {
                method: 'POST',
                headers: headers,
                body: contents
              });
      ...
      return runtime_1.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              common.Logger.debug("deleteFromGaiaHub: deleting " + filename + " from " + hubConfig.server);
              _context2.next = 3;
              return common.fetchPrivate(hubConfig.server + "/delete/" + hubConfig.address + "/" + filename, {
                method: 'DELETE',
                headers: {
                  Authorization: "bearer " + hubConfig.token
                }
  ...
  function makeLegacyAuthToken(challengeText, signerKeyHex) {
    ...
    if (parsedChallenge[0] === 'gaiahub' && parsedChallenge[3] === 'blockstack_storage_please_sign') {
      var signer = encryption.hexStringToECPair(signerKeyHex + (signerKeyHex.length === 64 ? '01' : ''));
      var digest = encryption.hashSha256Sync(Buffer.from(challengeText));
      var signatureBuffer = signer.sign(digest);
      var signatureWithHash = bitcoinjsLib.script.signature.encode(signatureBuffer, bitcoinjsLib.Transaction.SIGHASH_NONE);
      var signature = signatureWithHash.toString('hex').slice(0, -2);
      var publickey = encryption.getPublicKeyFromPrivate(signerKeyHex);
  ...
  function makeV1GaiaAuthToken(hubInfo, signerKeyHex, hubUrl, associationToken) {
    ...
    var iss = encryption.getPublicKeyFromPrivate(signerKeyHex);

    if (!handlesV1Auth) {
      return makeLegacyAuthToken(challengeText, signerKeyHex);
    }

    var salt = encryption.randomBytes(16).toString('hex');
    var payload = {
      ...
      return runtime_1.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              common.Logger.debug("connectToGaiaHub: " + gaiaHubUrl + "/hub_info");
              _context3.next = 3;
              return common.fetchPrivate(gaiaHubUrl + "/hub_info");
            ...
            case 6:
              ...
              address = encryption.ecPairToAddress(encryption.hexStringToECPair(challengeSignerHex + (challengeSignerHex.length === 64 ? '01' : '')));
      ...
      return runtime_1.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              challengeSigner = bitcoinjsLib.ECPair.fromPrivateKey(Buffer.from(appPrivateKey, 'hex'));
              _context4.next = 3;
              return common.fetchPrivate(gaiaHubUrl + "/hub_info");
            ...
            case 6:
              ...
              address = encryption.ecPairToAddress(challengeSigner);
        ...
        while (1) {
          switch (_context5.prev = _context5.next) {
            ...
            case 8:
              ...
              common.Logger.debug("Error getting bad http response text: " + _context5.t0);
        ...
        while (1) {
          switch (_context6.prev = _context6.next) {
            ...
            case 4:
              ...
              return _context6.abrupt("return", new common.ValidationError(errorMsg, gaiaResponse));
            ...
            case 9:
              ...
              return _context6.abrupt("return", new common.NotEnoughProofError(errorMsg, gaiaResponse));
            ...
            case 13:
              ...
              return _context6.abrupt("return", new common.BadPathError(errorMsg, gaiaResponse));
            ...
            case 17:
              ...
              throw new common.DoesNotExist(errorMsg, gaiaResponse);
            ...
            case 21:
              ...
              return _context6.abrupt("return", new common.ConflictError(errorMsg, gaiaResponse));
            ...
            case 25:
              ...
              return _context6.abrupt("return", new common.PreconditionFailedError(errorMsg, gaiaResponse));
            ...
            case 29:
              ...
              maxBytes = hubConfig && hubConfig.max_file_upload_size_megabytes ? common.megabytesToBytes(hubConfig.max_file_upload_size_megabytes) : 0;
              return _context6.abrupt("return", new common.PayloadTooLargeError(errorMsg, gaiaResponse, maxBytes));
            ...
            switch (_context.prev = _context.next) {
              case 0:
                defaults = {
                  decrypt: true,
                  verify: false,
                  app: common.getGlobalObject('location', {
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 3:
                ...
                _context5.next = 6;
                return common.fetchPrivate(readUrl);
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 10:
                ...
                throw new common.SignatureVerificationError('Failed to get gaia address for verification of: ' + ("" + path));
              ...
              case 12:
                ...
                throw new common.SignatureVerificationError('Failed to obtain signature for file: ' + (path + " -- looked in " + path + SIGNATURE_FILE_SUFFIX));
              ...
              case 27:
                signerAddress = encryption.publicKeyToAddress(publicKey);
                ...
                throw new common.SignatureVerificationError("Signer pubkey address (" + signerAddress + ") doesn't" + (" match gaia address (" + gaiaAddress + ")"));

              case 32:
                if (encryption.verifyECDSA(fileContents, publicKey, signature)) {
                  _context6.next = 36;
                  break;
                }

                throw new common.SignatureVerificationError('Contents do not match ECDSA signature: ' + ("path: " + path + ", signature: " + path + SIGNATURE_FILE_SUFFIX));
              ...
              case 39:
                ...
                if (!(_context6.t1 instanceof common.DoesNotExist && _context6.t1.message.indexOf(sigPath) >= 0)) {
                  _context6.next = 45;
                  break;
                }
          ...
          while (1) {
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                appPublicKey = encryption.getPublicKeyFromPrivate(appPrivateKey);
              ...
              case 8:
                address = encryption.publicKeyToAddress(appPublicKey);
              ...
              case 22:
                ...
                signerAddress = encryption.publicKeyToAddress(signerPublicKey);
                ...
                throw new common.SignatureVerificationError('Failed to get signature verification data from file:' + (" " + path));
              ...
              case 30:
                ...
                throw new common.SignatureVerificationError("Signer pubkey address (" + signerAddress + ") doesn't" + (" match gaia address (" + address + ")"));

              case 34:
                if (encryption.verifyECDSA(cipherText, signerPublicKey, signature)) {
                  _context7.next = 38;
                  break;
                }

                throw new common.SignatureVerificationError('Contents do not match ECDSA signature in file:' + (" " + path));
          ...
          while (1) {
            switch (_context10.prev = _context10.next) {
              ...
              case 4:
                ...
                maxUploadBytes = common.megabytesToBytes(gaiaHubConfig.max_file_upload_size_megabytes);
                ...
                sizeErr = new common.PayloadTooLargeError(sizeErrMsg, null, maxUploadBytes);
              ...
              case 14:
                ...
                encryptedSize = encryption.eciesGetJsonStringLength({
                ...
                _sizeErr = new common.PayloadTooLargeError(_sizeErrMsg, null, maxUploadBytes);
              ...
              case 27:
                ...
                signatureObject = encryption.signECDSA(privateKey, contentData);
              ...
              case 38:
                if (typeof opt.encrypt === 'string') {
                  ...
                  publicKey = encryption.getPublicKeyFromPrivate(opt.sign);
                } else {
                  publicKey = encryption.getPublicKeyFromPrivate(this.userSession.loadUserData().appPrivateKey);
                }
          ...
          while (1) {
            switch (_context12.prev = _context12.next) {
              ...
              case 7:
                ...
                _context12.next = 13;
                return common.fetchPrivate(hubConfig.server + "/list-files/" + hubConfig.address, fetchOptions);
          ...
          while (1) {
            switch (_context13.prev = _context13.next) {
              case 0:
                ...
                throw new common.InvalidStateError('Missing userData');
        ...
        return runtime_1.wrap(function _callee14$(_context14) {
          while (1) {
            switch (_context14.prev = _context14.next) {
              ...
              case 3:
                if (!userData.hubUrl) {
                  userData.hubUrl = common.BLOCKSTACK_DEFAULT_GAIA_HUB_URL;
                }
    ...
    if (opts.username) {
      ...
      if (!opts.zoneFileLookupURL) {
        ...
        if (!userSession.store) {
          throw new common.InvalidStateError('Missing store UserSession');
        }
        ...
        if (configuredCoreNode) {
          opts.zoneFileLookupURL = "" + configuredCoreNode + auth.NAME_LOOKUP_PATH;
        }
      }
    }
...
//# sourceMappingURL=storage.umd.development.js.map
